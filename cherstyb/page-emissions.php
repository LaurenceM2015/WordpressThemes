<?php 
    /* Template Name: Mes Emissions */
    get_header('menu2');

    // Page Section Start here 
    $thumbnail_url	= wp_get_attachment_url( get_post_thumbnail_id( $post->ID ) );

    // Talk show Hero Section playlist id:
    ...
    $carousel_emission_img   = get_field('carousel_emission_img',11);
...
<?php } else { // fallback image ?>
	...
	<header class="header-blog parallax-window" data-z-index="0" data-parallax="scroll" data-image-src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/WhatsApp-Image.jpg">
...
<section class="projects-section page-section" id="section-talkshow">
  <!-- remove the column-count: 4; -->
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
